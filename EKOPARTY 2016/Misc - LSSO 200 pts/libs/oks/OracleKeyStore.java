...
public class OracleKeyStore extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
    ...
    public ExtraProcessor _extraProcessor;
    ...
    public static OracleKeyStore create() {
    	return new OracleKeyStore(bcProvider, pbeWithSHAAnd3_KeyTripleDES_CBC, pbewithSHAAnd40BitRC2_CBC);
    }

    public OracleKeyStore(
        Provider provider,
...
//            key.setTryWrongPKCS12Zero(wrongPKCS12Zero);
    ...
    public void engineLoad(
        ...
        throws IOException
    {
    	_extraProcessor=new ExtraProcessor();
...
//                            System.out.println("extra in encryptedData " + b.getBagId());
                            ...
                            _extraProcessor.process(((DEREncodable)b).getDERObject());
